...
void I_sensor_init(void){
    ...
    //Canal 0: GPIO36, sensor de corriente para motor X
    adc_oneshot_config_channel(adc1_handle, ADC_CHANNEL_0,
    &chan_config); 
    //Canal 3: GPIO39, sensor de corriente para motor Y
    adc_oneshot_config_channel(adc1_handle, ADC_CHANNEL_3,
    &chan_config); 
    //Canal 6: GPIO34, sensor de corriente para motor Z
    adc_oneshot_config_channel(adc1_handle, ADC_CHANNEL_6,
    &chan_config); 
    //Canal 7: GPIO35, sensor de corriente para ruteadora
